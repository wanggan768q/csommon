...
from pipeline import build_apk
...
def processRoutine():
    ...
    # 构建客户端
    if args.dev_build:
        build_apk.buildPackage("cn", "GooglePlay", "dev")
    if args.dev_upload_assetbundle:
        build_apk.uploadAssetBundle("cn", "GooglePlay", "dev")
    if args.dev_upload_package:
        build_apk.uploadPackage("cn", "GooglePlay", "dev")

    if args.beta_build:
        build_apk.buildPackage("cn", "GooglePlay", "beta")
    if args.beta_upload_assetbundle:
        build_apk.uploadAssetBundle("cn", "GooglePlay", "beta")
    if args.beta_upload_package:
        build_apk.uploadPackage("cn", "GooglePlay", "beta")

    if args.release_build:
        build_apk.buildPackage("cn", "GooglePlay", "release")
    if args.release_upload_assetbundle:
        build_apk.uploadAssetBundle("cn", "GooglePlay", "release")
    if args.release_upload_package:
        build_apk.uploadPackage("cn", "GooglePlay", "release")
