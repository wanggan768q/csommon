...
#ifndef __MODULE_STORYDUNGEON_H
#define __MODULE_STORYDUNGEON_H


#include "ModuleBase.h"
#include "StoryDungeonRpcWraper.h"
...
//剧情副本实现类
class ModuleStoryDungeon : public ModuleBase
{
	DECLARE_INSTANCE(ModuleStoryDungeon);
public:
...
public:
	...
	********************************************************************************************/
	virtual int RpcSyncData( INT64 UserId, StoryDungeonRpcSyncDataAskWraper& Ask, StoryDungeonRpcSyncDataReplyWraper& Reply );
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	virtual int RpcChallenge( INT64 UserId, StoryDungeonRpcChallengeAskWraper& Ask, StoryDungeonRpcChallengeReplyWraper& Reply );
	...
	* Return:         无
	********************************************************************************************/
	virtual void SendToClientWaitForConfirmation( INT64 UserId, StoryDungeonRpcWaitForConfirmationNotifyWraper& Notify );
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	virtual int RpcConfirmEnter( INT64 UserId, StoryDungeonRpcConfirmEnterAskWraper& Ask, StoryDungeonRpcConfirmEnterReplyWraper& Reply );
	...
	* Return:         无
	********************************************************************************************/
	virtual void SendToClientPlayerConfirmResult( INT64 UserId, StoryDungeonRpcPlayerConfirmResultNotifyWraper& Notify );
