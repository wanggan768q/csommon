...
ModuleMail::ModuleMail()
{
	...
	MsgIdMgr::Instance().MsgRegister( this, &ModuleMail::RpcMailHead);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleMail::RpcOpenMail);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleMail::RpcDelMail);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleMail::RpcGetReward);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleMail::RpcOneKeyGetReward);
