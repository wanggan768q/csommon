...
ModuleFight::ModuleFight()
{
	...
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::RpcReady);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::RpcAction);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleFight::RpcEnter);
