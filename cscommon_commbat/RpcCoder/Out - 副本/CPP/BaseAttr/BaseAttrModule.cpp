...
ModuleBaseAttr::ModuleBaseAttr()
{
	...
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcSyncData);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcGetRankReward);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcUpGradeRank);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcChooseRole);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcLevelUp);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcGetTimer);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcRevive);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcQueryEquip);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcUpdateNewbieGuide);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcChangPKState);
	MsgIdMgr::Instance().MsgRegister( this, &ModuleBaseAttr::RpcChangePKProtect);
