...
#ifndef __DATA_ACHIEVEMENT_H
#define __DATA_ACHIEVEMENT_H
...
//成就数据类
class DataAchievement : public ModuleData
{
	DECLARE_INSTANCE(DataAchievement);
public:
