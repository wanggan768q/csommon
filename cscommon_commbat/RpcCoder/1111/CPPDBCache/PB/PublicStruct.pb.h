...
class gong : public ::google::protobuf::Message {
 public:
  gong();
  virtual ~gong();

  gong(const gong& from);

  inline gong& operator=(const gong& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const gong& default_instance();

  void Swap(gong* other);
  ...
  void CopyFrom(const gong& from);
  void MergeFrom(const gong& from);
  void Clear();
  ...
  // @@protoc_insertion_point(class_scope:gong)
 private:
