...
#ifndef __DATA_TESTMODULE_H
#define __DATA_TESTMODULE_H
...
{
	MODULE_ID_TESTMODULE = 1,

};


//TestModule数据类
class DataTestModule : public ModuleData
{
	DECLARE_INSTANCE(DataTestModule);
public:
